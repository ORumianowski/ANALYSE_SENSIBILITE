...
p1 = ggplot() +
  geom_line(data = effectif_data, aes(x = temps, y = S, color = "S"), linewidth = 1) +
  geom_line(data = effectif_data, aes(x = temps, y = L, color = "E"), linewidth = 1) +
  geom_line(data = effectif_data, aes(x = temps, y = I, color = "I"), linewidth = 1) +
  geom_line(data = effectif_data, aes(x = temps, y = R, color = "R"), linewidth = 1) +
  geom_line(data = effectif_data, aes(x = temps, y = N, color = "N"), linewidth = 1) +
  labs(x = "Temps", y = "Effectif") +
  labs(color = "Etat") +
  theme_minimal() +
