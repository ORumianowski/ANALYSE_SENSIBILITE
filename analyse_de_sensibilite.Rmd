...
plot_ly(x = x, y = y, z = z, type = "scatter3d", mode = "markers", color = "black")
...
Les résultats sont très différents pour la sortie 1 et semblables pour la sortie 3. Dans tous les cas, on voit que la méthode FAST tend à surestimer l'effet des paramètres lorsqu'il y a peu de scénarios par paramètre
